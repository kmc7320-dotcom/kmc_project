...
@Repository
public class UserDAOImp_ch06 implements UserDAO_ch06 {
	...
	public UserDTO_6 selectUser(int userId) {
		...
		UserDTO_6 user = sqlSession.selectOne("com.spring.mvc_mybatis.ch06.dao.UserDAO_ch06.selectUser",userId);
	...
	public int insertUser(UserDTO_6 dto) {
		...
		int insertCnt = sqlSession.insert("com.spring.mvc_mybatis.ch06.dao.UserDAO_ch06.insertUser", dto);
	...
	public int updateUser(UserDTO_6 dto) {
		...
		int updateCnt = sqlSession.update("com.spring.mvc_mybatis.ch06.dao.UserDAO_ch06.updateUser", dto);
		return updateCnt;
	}
